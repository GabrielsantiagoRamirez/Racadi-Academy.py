...
const info_cuenta = async () => {
    try {
        const response = await axios.get(`https://apiracadipy-production.up.railway.app/datos_cuenta/${usuario.value.documento}`);
...
const info_pagos = async () => {
    try {
        const response = await axios.get(`https://apiracadipy-production.up.railway.app/getStudentpayments/${usuario.value.documento}`);
