...
<template>
    ...
    <div class="contMadre_niveles">
       ...
       <div class="contNiveles">
            ...
            <div class="niveles">A2</div>
            <div class="niveles">B1</div>
            <div class="niveles">B2</div>
            <div class="niveles">C1</div>
            <div class="niveles">C2</div>
       </div>
    ...
    <div class="contNiveles_unete">
        <img src="..//components/img/logoRacadi.png" class="logo_unete">
        <div class="texto_unete">Logra tu meta de aprender hablar ingles on nosotros.</div>
    </div>
...
.contMadre_niveles {
    height: auto;
    width: 100%;
    background-color: #3aacd900;
    display: flex;
    justify-content:center; /* Centrar horizontalmente el contenedor de niveles */
    flex-direction: column;
    padding: 20px 0; /* Ajusta según necesites */
    margin-top: 6%;
    margin-bottom: 6%;
}.contMadre_niveles h1{
   margin-left: auto;
   margin-right: auto;
   font-family: "Anek Devanagari", sans-serif;
    font-size: 9vh;
...
.contNiveles {
    ...
    gap: 4%; /* Espacio entre los cuadrados */
     height: auto;/* Espacio interno del contenedor */
    margin-top: 6%;
}
...
.niveles {
    ...
    font-size: 320%;
    font-family: "Anek Devanagari", sans-serif;
    aspect-ratio: 1; /* Mantiene los divs cuadrados */
