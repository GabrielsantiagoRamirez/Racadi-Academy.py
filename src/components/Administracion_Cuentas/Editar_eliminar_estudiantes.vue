...
const deleteStudent = async (documento) => {
  try {
    await axios.put(`https://apiracadipy-production.up.railway.app/desactivarestudiante/${documento}`);
    Swal.fire({
      icon: 'success',
...
const activeStudent = async (documento) => {
  try {
    await axios.put(`https://apiracadipy-production.up.railway.app/activarestudiante/${documento}`);
    Swal.fire({
      icon: 'success',
